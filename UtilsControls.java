...
class UtilsControls{
	...
	static float newMaxByControl1(MaximizingBy newMaxBy,ArrayList<HTEntry> all,float currentProfit,float currEval)
	{
	...
	static float newMaxyByControl2(MaximizingBy newMaxBy,ArrayList<HTEntry> all,float currentProfit,float currEval)
	{
	...
	static float newMaxByControl3(MaximizingBy newMaxBy,ArrayList<HTEntry> all,float currentProfit,float currEval)
	{
	...
	static float finalControls4(float currEval,float bestEval,float bestProfit,float bestWinRatio,float bestTH,float step, String bestDescription, 
			int x, int y, int z, int w, float bestx, float besty, float bestz, float bestw, float currentProfit, float currentWinRate, float currentTH)
	{
	...
	static float expectedControl(float expected,float avgShotsOver,float avgShotsUnder,float dist)
	{
	...
	static float expectedNotControl(float expected,float avgShotsOver,float avgShotsUnder,float dist)
	{
	...
	static float bankControls(Calendar cal,int month,FinalEntry i,float betSize,int succ,int alls,float bank)
	{
	...
	static float bankNotControls(Calendar cal,int month,FinalEntry i,float betSize,int succ,int alls,float bank)
	{
		if (cal.get(Calendar.MONTH) != month) {
